...
export function MDXCard({
  ...
  return (
    <Link
      href={href}
      className={cn(
        "group flex flex-col justify-between rounded-xl border border-border/40 bg-background/60 p-6 shadow-sm transition-all hover:bg-muted/50 hover:shadow-md backdrop-blur-md"
      )}
    >
      <div>
